...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {		
	videoDevice = [[QTCaptureDevice inputDevicesWithMediaType:QTMediaTypeVideo] objectAtIndex:1];
	...
	[captureView setVideoPreviewConnection:[[captureView availableVideoPreviewConnections] objectAtIndex:1]];
